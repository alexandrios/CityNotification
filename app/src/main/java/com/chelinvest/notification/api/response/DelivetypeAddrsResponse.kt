...
@Root(name = "delivetype_addrs", strict = false)
class DelivetypeAddrsResponse : IResponseElement {
    ...
    @field:ElementList(name = "address_list", type = DeliveAddrBranchResponse::class)
    var address_list: Collection<DeliveAddrBranchResponse>? = null
